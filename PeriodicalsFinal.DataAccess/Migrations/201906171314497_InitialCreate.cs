namespace PeriodicalsFinal.DataAccess.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ArticleTitle = c.String(nullable: false, maxLength: 300),
            ...
            CreateTable(
                ...
                c => new
                    {
                        EditionId = c.Guid(nullable: false),
                        EditionTitle = c.String(nullable: false, maxLength: 300),
                        PublishDate = c.DateTime(nullable: false),
                        EditionPrice = c.Single(nullable: false),
                        TopicId = c.Guid(nullable: false),
                        EditionImage = c.Binary(),
                        EditionStatus = c.Int(nullable: false),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        SubscriptionId = c.Guid(nullable: false, identity: true),
                        EditionId = c.Guid(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Article", new[] { "EditionId" });
            DropTable("dbo.Topic");
